...
import com.paulniu.library.constants.RequestPermissions;
...
public class PermissionUtils {
     ...
     * uuid默认路径
     */
    public final static String uuidDefaultPath = Environment.getExternalStorageDirectory() + "/ying/uuid.tm";
    ...
    public static void requestWritePermission(Activity activity) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            final String[] arrRequestPermission = PermissionUtils.getRequestPermission(activity, Manifest.permission.WRITE_EXTERNAL_STORAGE);
